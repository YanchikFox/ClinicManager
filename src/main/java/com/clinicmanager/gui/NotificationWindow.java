...
public class NotificationWindow {
  ...
  public static void showNotifications(
      Stage owner, NotificationService notificationManager, int personId) {
    ...
    Runnable refreshList =
        () -> {
          ...
          List<Notification> notifications =
              notificationManager.getAllNotificationsByPersonId(personId);
          listView.setItems(
