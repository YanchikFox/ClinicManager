...
//                try {
//                    int doctorId = repositories.doctors().save(new Doctor(0, "Dr. Smith",
// "1980-01-01", "123456789", 0));
//                    int scheduleId = repositories.schedules().save(new Schedule(0, doctorId));
//                    int patientId = repositories.patients().save(new Patient(0, "John Doe",
// "1990-01-01", "987654321", 0));
//                    int slotId = repositories.slots().save(new Slot(scheduleId, LocalDate.of(2024,
// 1, 1),
//                            new TimeRange(LocalTime.of(9, 0), LocalTime.of(9, 30))));
//                    appointmentId = repositories.appointments().save(new Appointment(0, patientId,
// doctorId, slotId,
...
//    }
//
//    private void executeSqlScript(Connection connection, String resourcePath) throws IOException,
// SQLException {
