...
public class FxControllerFactory implements Callback<Class<?>, Object> {
    ...
    public FxControllerFactory(ClinicFacade clinic,
    ...
    public Object call(Class<?> type) {
        ...
        if (type == DoctorPanelController.class) {
            return new DoctorPanelController(panelManager, repositories, slotGenerationService, viewLoader());
        }
        ...
        if (type == PatientPanelController.class) {
            return new PatientPanelController(panelManager, repositories, notificationService, viewLoader());
        }
